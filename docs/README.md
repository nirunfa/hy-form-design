...
# 表单设计器 hy-form-design![](https://img.shields.io/github/stars/Kchengz/hy-form-design?style=social)
...
- [预览地址](https://HyForm.epicjs.cn/preview.html)
- [开源地址](https://github.com/Kchengz/hy-form-design)
...
### 版本
[![](https://img.shields.io/npm/v/hy-form-design.svg?style=flat-square)](https://www.npmjs.com/package/hy-form-design)

### 组件
- HyFormDesign 表单设计器（基于可视化操作快速设计出表单页面，生成配置json或页面）
- HyFormBuild 表单构建器（根据设计器中获取的配置json数据，快速构建出表单页面）
...
import 'hy-form-design/packages/core/useComponents'
...
### 捐赠
如果你觉得hy-form-design对你有帮助，欢迎给我捐赠
